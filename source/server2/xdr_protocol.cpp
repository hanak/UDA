                                        ...
                                        UserDefinedTypeList* user_defined_type_list)
{
    ...
    if (!xdrrec_skiprecord(&server_input_)) {
        ...
        if ((err = protocol2(&server_input_, protocol_id, XDR_RECEIVE, nullptr, log_malloc_list, user_defined_type_list,
                             client_block, protocol_version_, &log_struct_list_, 0,
                             malloc_source_)) != 0) {
                                     ...
                                     UserDefinedTypeList* user_defined_type_list)
{
    ...
    if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                         &metadata_block.data_system, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
    ...
    if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                         &metadata_block.system_config, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
    ...
    if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                         &metadata_block.data_source, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
    ...
    if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                         &metadata_block.signal_rec, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
    ...
    if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                         &metadata_block.signal_desc, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
                                       ...
                                       UserDefinedTypeList* user_defined_type_list)
{
    ...
    if ((err = protocol2(&server_output_, UDA_PROTOCOL_DATA_BLOCK_LIST, XDR_SEND, nullptr, log_malloc_list,
                         user_defined_type_list, (void*)&data_block_list, protocol_version_, &log_struct_list_,
                         0, malloc_source_)) != 0) {
                                            ...
                                            UserDefinedTypeList* user_defined_type_list)
{
    if (protocol_version_ < 9 && data_block.data_type == UDA_TYPE_COMPOUND &&
        ...
        int err = 0;
        if ((err = protocol2(&server_output_, protocol_id, XDR_SEND, nullptr, log_malloc_list, user_defined_type_list,
                             (void*)&data_block, protocol_version_, &log_struct_list_, 0,
                             malloc_source_)) != 0) {
                                         ...
                                         UserDefinedTypeList* user_defined_type_list)
{
    ...
    if ((err = protocol2(&server_input_, UDA_PROTOCOL_REQUEST_BLOCK, XDR_RECEIVE, nullptr, log_malloc_list,
                         user_defined_type_list, request_block, protocol_version_, &log_struct_list_,
                                              ...
                                              UserDefinedTypeList* user_defined_type_list)
{
    ...
    if ((err = protocol2(&server_input_, UDA_PROTOCOL_PUTDATA_BLOCK_LIST, XDR_RECEIVE, nullptr, log_malloc_list,
                         user_defined_type_list, putdata_block_list, protocol_version_,
...
void uda::XdrProtocol::write_to_cache(uda::cache::UdaCache* cache, RequestData* request, server::Environment& environment,
                                      DataBlock* data_block, LogMallocList* log_malloc_list,
                                      UserDefinedTypeList* user_defined_type_list)
{
    cache_write(cache, request, data_block, log_malloc_list, user_defined_type_list, *environment.p_env(), 8, CLIENTFLAG_CACHE,
